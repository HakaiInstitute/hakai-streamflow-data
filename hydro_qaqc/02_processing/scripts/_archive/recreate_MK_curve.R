# =============================================================================
# Recreate MK's original SSN703 rating curve (v4 pipeline, Ratings 1-3)
# =============================================================================
# STANDALONE. Sources no other project script. Needs: tidyverse, plotly.
# (qmixnorm is reimplemented inline so KScorrect is NOT required.)
#
# WHAT THIS DOES
...
#   + console diagnostics
#
# Run:  Rscript 02_processing/scripts/recreate_MK_curve.R
...
# -----------------------------------------------------------------------------
# 1. INLINE REIMPLEMENTATIONS of MK's helper functions
#    (selectspan / interp1 / interp2 / HQ_unc / CI_model_input / CI)
# -----------------------------------------------------------------------------

# mixture-of-normals quantile (equal weights), replacing KScorrect::qmixnorm.
# expand multiplies component sds (matches KScorrect's `expand`).
qmixnorm_ <- function(p, mean, sd, expand = 1) {
